 ...
 * compatibility.
 */
public class CompatEventBus__variant__Test
    extends TestCase {
  ...
  public void testAddAndRemoveHandlers() {
    ...
    FooEvent.register(eventBus,
                      fooHandler1);
    FooEvent.register(eventBus,
                      fooHandler2);
    HandlerRegistration reg1 = FooEvent.register(eventBus,
                                                 adaptor1);
    eventBus.fireEvent(new FooEvent());
    assertEquals(3,
                 countingEventBus.getHandlerCount(CompatEventBus.getNewType(FooEvent.TYPE)));
    ...
    FooEvent.register(eventBus,
                      fooHandler2);
    HandlerRegistration reg2 = FooEvent.register(eventBus,
                                                 adaptor1);
    ...
    assertEquals(7,
                 countingEventBus.getHandlerCount(CompatEventBus.getNewType(FooEvent.TYPE)));
    eventBus.addHandler(BarEvent.TYPE,
                        adaptor1);
    eventBus.addHandler(BarEvent.TYPE,
                        barHandler1);
    eventBus.addHandler(BarEvent.TYPE,
    ...
    assertEquals(7,
                 countingEventBus.getHandlerCount(CompatEventBus.getNewType(FooEvent.TYPE)));
    assertEquals(3,
                 countingEventBus.getHandlerCount(CompatEventBus.getNewType(BarEvent.TYPE)));
  ...
  private void assertFired(Object... handler) {
    for (Object aHandler : handler) {
      assertTrue(aHandler + " should have fired",
                 active.contains(aHandler));
    }
  }
  ...
  private void assertNotFired(Object... handler) {
    for (Object aHandler : handler) {
      assertFalse(aHandler + " should not have fired",
                  active.contains(aHandler));
    }
  }
  ...
  public void testAssertThrowsNpe() {
    ...
    try {
      assertThrowsNpe(() -> FooEvent.register(eventBus,
                                              fooHandler1));
    ...
    FooEvent.Handler one =
        new FooEvent.Handler() {
          ...
          private HandlerRegistration addIt() {
            return FooEvent.register(eventBus,
                                     fooHandler1);
          }
        };
  ...
  public void testConcurrentRemove() {
    ...
    FooEvent.register(eventBus,
                      fooHandler1);
    h.r = FooEvent.register(eventBus,
                            h);
    FooEvent.register(eventBus,
                      fooHandler2);
    FooEvent.register(eventBus,
  ...
  public void testHandlersThrow() {
    ...
    FooEvent.register(eventBus,
                      fooHandler1);
    FooEvent.register(eventBus,
                      new ThrowingHandler(exception1));
    FooEvent.register(eventBus,
                      fooHandler2);
    FooEvent.register(eventBus,
                      new ThrowingHandler(exception2));
    FooEvent.register(eventBus,
                      fooHandler3);
    ...
    try {
      ...
      assertEquals("Exception should wrap the two thrown exceptions",
                   2,
                   causes.size());
  ...
  public void testNoDoubleRemove() {
    final CompatEventBus eventBus = new CompatEventBus(new SimpleEventBus());
    HandlerRegistration  reg      = FooEvent.register(eventBus,
                                                      fooHandler1);
    reg.removeHandler();
  ...
  public void testNullChecks() {
    final CompatEventBus eventBus = new CompatEventBus(new SimpleEventBus());
    assertThrowsNpe(() -> eventBus.addHandler(null,
                                              fooHandler1));
    ...
    assertThrowsNpe(() -> FooEvent.register(eventBus,
                                            null,
                                            fooHandler1));
    assertThrowsNpe(() -> eventBus.addHandlerToSource(null,
                                                      "foo",
                                                      fooHandler1));
    ...
    assertThrowsNpe(() -> eventBus.fireEventFromSource(new FooEvent() {
