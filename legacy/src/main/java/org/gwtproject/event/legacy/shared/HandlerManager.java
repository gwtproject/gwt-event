...
public class HandlerManager implements HasHandlers {
  ...
  /**
   * Creates a handler manager with a source to be set on all events fired via {@link
   * #fireEvent(Event)}. Handlers will be fired in the order that they are added.
   *
   ...
   *
   * <p>Note, any subclass should be very careful about overriding this method, as adds/removes of
